!function () {
    ...
    function a() {
        var e = window.pageYOffset, t = window.innerHeight,
            ...
            o = 0, i = 0, a = (m = !0, document.getElementById("t-header")), r = document.getElementById("t-footer"),
            d = document.getElementById("tildacopy"),
            c = (a && (o = a.offsetHeight), r && (i = r.offsetHeight), d && (i += d.offsetHeight), Math.floor(100 * (e - o + t) / (n - o - i)));
        if (!(c < 10)) for (var l = [10, 25, 50, 75, 90], s = 0; s < l.length; s++) {
            var u = l[s], p = l.length - 1;
            if (0 === s && u <= c && !w["p" + u]) g.page = "/tilda/scroll/" + u + "/", window.tildastat("pageview"), w["p" + u] = !0; else if (u - 1 <= c) {
                if (0 === w["p" + u]) {
    ...
    function u() {
        if (!("" < g.user_agent && -1 != g.user_agent.indexOf("bot"))) if ("http:" != window.location.protocol && "https:" != window.location.protocol) console.log("TildaStat: cannot work on local page"); else {
            var t;
    ...
    function p() {
        ...
        var e = function (e) {
            var t, n = "";
            for (t in e) if ("" != n && "object" != typeof e[t] && (n += "&"), "object" == typeof e[t]) {
    ...
    var g = {}, w = {p10: 0, p25: 0, p50: 0, p75: 0, p90: 0}, m = !0, f = "no" === window.tildastatcookie,
        ...
        y = "", b = !1, t = (window.tildastat("create"), setTimeout(function () {
        ...
        }, 2e3)), i = document.querySelector("link[rel*='shortcut icon']"),
        ...
        x = i ? i.getAttribute("href") : "", E = document.querySelector("script[src*='js/tilda-scripts']"),
