...
function t_animate__checkMobile(t) {
    return Array.prototype.filter.call(t, function (t) {
        var e = t.closest(".t396__elem"), a = e ? e.getAttribute("data-animate-mobile") : null;
...
function t_animate__generateStyles() {
    if (!!document.querySelector(".t396")) {
        ...
        var i = document.createElement("style"), r = document.head || document.querySelector("head");
...
function t_animate__getMediaQuery(t, e) {
    var a = "", n = !1, i = t[e + 1], r = t[e] - 1, o = e === t.length - 1, t = e === t.length - 2;
...
function t_animate__startAnimation() {
    ...
    }), o = document.querySelectorAll(".t-animate"), o = Array.prototype.filter.call(o, function (t) {
...
function t_animate__getSectionHeadDealy(t) {
    var e = t.querySelector(".t-section__title.t-animate"), a = t.querySelector(".t-section__descr.t-animate"), t = 0;
    if (e) {
...
function t_animate__parseNumberText() {
    var o = window.pageYOffset, t = document.querySelectorAll(".t-animate[data-animate-style='animatednumber']");
    Array.prototype.forEach.call(t, function (t) {
        var e, a, n, i = "", r = t.querySelectorAll("span");
...
function t_animate__animateNumbers(e) {
    if (!e) return !1;
    var a = e.getAttribute("data-animate-number-count"), n = [], t = e.querySelectorAll("span");
    (t = Array.prototype.filter.call(t, function (t) {
        return !t.classList.contains(".t-animate__number")
...
function t_animate__getAttrByResBase(t, e) {
    ...
    var i, r, n = "ab" + n.getAttribute("data-artboard-recid"),
        ...
        n = t.closest(".t396__elem"), n = n ? n.getAttribute("data-animate-mobile") : null;
    if (i === r) a = t.getAttribute("data-animate-" + e); else {
        if ("y" !== n && i < 1200) return t.style.transition = "none", null;
        a = t.getAttribute("data-animate-" + e + "-res-" + i)
    }
    if (!a && "" !== a) for (var s = 0; s < o.length; s++) {
        var l = o[s];
...
function t_animate__detectElemTriggerOffset(t, e) {
    var a = t_animate__getAttrByResBase(t, "trigger-offset"), t = e;
...
function t_animate__checkIE() {
    var t, e = window.navigator.userAgent, a = e.indexOf("MSIE"), n = !1;
