...
function cover_init(e) {
    var t = document.getElementById("allrecords"), t = !!t && "yes" === t.getAttribute("data-tilda-lazy"),
...
function t_cover__recalcCoverHeight(e, t) {
    var o, r, n, i, c, a, d, _, l = document.getElementById("rec" + e);
    l && (e = l.querySelector(".t-cover"), o = "935" === l.getAttribute("data-record-type"), e && !o && ((a = (o = l.querySelector(".t-cover__carrier")) ? o.getAttribute("data-content-cover-height") : "") || (a = (r = l.querySelector("[data-content-cover-height]")) ? r.getAttribute("data-content-cover-height") : ""), r = "y" === l.getAttribute("data-fixed-bg"), n = [".t-cover", ".t-cover__filter", ".t-cover__carrier", ".t-cover__wrapper", ".t-slds__items-wrapper"], i = "dynamic" === o.getAttribute("data-content-cover-parallax"), (c = t_cover__getHeightFromAttr(a)) && n.forEach(function (e) {
        i && ".t-cover__carrier" === e || Array.prototype.slice.call(l.querySelectorAll(e)).forEach(function (e) {
            e && (e.style.height = Math.round(c) + "px")
        })
    }), a = t_cover__getHeightFromAttr(a), _ = t_cover__getPureHeight(e), a = a || _, r || (d = e.style.height, e.style.height = "", a = _, d && (e.style.height = d)), _ = t_cover__getContentHeight(l), e = !!o && "100vh" === o.getAttribute("data-content-cover-height"), 300 < _ && a < _ + 40 || r || (window.t_cover__isMobile || "ontouchend" in document) && t ? (t_cover__setRecalculatedHeight(l, _), t_cover__updateResizeElem(l)) : window.t_cover__isMobile && e && n.forEach(function (e) {
        e = l.querySelector(e);
...
function t_cover__setRecalculatedHeight(t, e) {
    var o = t.querySelector(".t-cover__carrier"), r = o ? o.getAttribute("data-content-cover-height") : "",
        ...
        r = "734" === t.getAttribute("data-record-type"), c = window.innerWidth <= 568 ? 40 : 120,
        a = window.innerWidth <= 568 ? 50 : 100, d = (r && (a = c = 0), 1e3 < (e += c) && (e += a), n < e ? e : n),
        _ = 0,
        r = ([".t-cover", ".t-cover__filter", ".t-cover__carrier", ".t-cover__wrapper", ".t-cover__container", ".t-slds__items-wrapper"].forEach(function (e) {
            Array.prototype.slice.call(t.querySelectorAll(e)).forEach(function (e) {
                i && e && e.classList.contains("t-cover__carrier") && d < document.documentElement.clientHeight ? (_ = .2 * document.documentElement.clientHeight, e.style.height = d + _ + "px") : e && (e.style.height = d + "px")
            })
        }), o.setAttribute("data-content-cover-updated-height", d + _ + "px"), document.createEvent("Event"));
    r.initEvent("coverHeightUpdated", !0, !0), o.dispatchEvent(r)
}
